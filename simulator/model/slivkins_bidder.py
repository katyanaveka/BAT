...
# GLobal questions:
# what to do with allocation profile an
# and then with price
# what to do with hyperparametres
...
class SlivkinsBidder(_Bidder):
    ...
    def __init__(self, params: dict = None):
        ...
        # need only value, because we already have logged
        # price and allocation profiles in History, 
        # when value depends on prev_ctr
    ...
    def place_bid(self, bidding_input_params: Dict[str, any], history: History) -> float:
        ...
        self.w=initial_balance
        self.gamma = self.theta / self.w
        self.mu_roi = self.gamma - 1
